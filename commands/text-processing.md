...
| [awk](./detailed/awk.md) | awk '{print $N}' <file>                               | Print specific column(s) [NF=total Number of fields]                                                               | awk '{print $1, $3}' data.txt                                     |
...
| Command                    | Syntax                   | Description                             | Example                                                                                                                                                               |
| -------------------------- | ------------------------ | --------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [grep](./detailed/grep.md) | grep "pattern" <file>    | Search for a pattern                    | grep "error" log.txt                                                                                                                                                  |
